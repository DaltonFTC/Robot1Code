...
#pragma config(SrvoPosition,  Position02,            146,  25, 235, 112, 128, 128, 128, 128)
...
task main()
{
	...
	float scale = 2.1; //scale the motors down
	while (true)
	{
		///////////////////////////////////////////////////////////
		///////////////////////////////////////////////////////////
		...
		motor[motorE] = scaleForMotor(joystick.joy1_y1)*scale*-1; //rgt
